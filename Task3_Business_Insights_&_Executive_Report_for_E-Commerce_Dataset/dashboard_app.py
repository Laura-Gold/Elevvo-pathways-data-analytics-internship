# dashboard_app.py
"""
Streamlit dashboard — clean rewrite (Option 2)
Single-file, dark-themed interactive dashboard for the Olist dataset.
Place the CSV files listed below in the same folder as this script:
  - Olist_Cleaned_Full_Dataset.csv
  - Olist_Sales_By_Month.csv (optional)
  - Olist_Sales_By_State.csv (optional)
  - Olist_Sales_By_Category.csv (optional)
  - Olist_Customers_By_State.csv (optional)
  - Olist_Payment_Methods.csv (optional)
  - Olist_Order_Status.csv (optional)
  - Olist_Delivery_Performance.csv (optional)
  - Olist_RFM_Segments.csv (optional)
...
# -----------------------
# Page 3: Executive Report (detailed)
# -----------------------
with tab3:
...
- **Top 3 product categories by revenue:** A, B, C
